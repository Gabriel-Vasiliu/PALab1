        ...
        while(line <= 2){
            ...
            while(aux_source > 0) { //cauta minimul pe linia line cat timp este "marfa" la sursa
                ...
                if (aux_destination > 0){
                    System.out.println(source.getName() + " -> " + destination.getName() + " : " + aux_source + " units * cost " +
                            cost[line][indexColumn] + " = " + aux_source*cost[line][indexColumn]);
